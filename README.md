## Implemention of a synchronous counter using a FSM

I wanted to produce a SystemVerilog program to test one of my Tripos exam answer. In this question, I had to use J-K bistables to implement a divide by 4 counter, which it will increment the output when the input is 0 and decrement the output when the input is 1.

## Digital Circuit Design

This is the digital circuit I designed:
...
I want to redo this, with FPGA implementation in mind. This is because J-K bistables are not commonly used in FPGA design and I want to remove the 2 cycle delay.
